...
permanova_bacteria <- adonis(bacteria_bray ~ rootstock+root_depth+vine+rootstock*root_depth,
       data = bacteria_meta, permutations=999, method = "bray")

permanova_bacteria

# Call:
#   adonis(formula = bacteria_bray ~ rootstock + root_depth + vine +      rootstock * root_depth, data = bacteria_meta, permutations = 999,      method = "bray") 
# 
# Permutation: free
...
#   root_depth            2    0.6514 0.32572  1.9200 0.08608  0.005 ** 
#   vine                  9    2.5282 0.28091  1.6559 0.33407  0.001 ***
#   rootstock:root_depth  4    0.7305 0.18263  1.0765 0.09653  0.311    
...
permanova_fungi <- adonis(fungi_bray ~ rootstock+root_depth+vine+rootstock*root_depth,
                             data = fungi_meta, permutations=999, method = "bray")

permanova_fungi
# 
# Call:
#   adonis(formula = fungi_bray ~ rootstock + root_depth + vine +      rootstock * root_depth, data = fungi_meta, permutations = 999,      method = "bray") 
# 
# Permutation: free
# Number of permutations: 999
# 
...
# root_depth            2    0.4147 0.20733 1.42518 0.12229  0.132   
# vine                  6    0.9488 0.15813 1.08697 0.27982  0.375   
# rootstock:root_depth  3    0.3996 0.13321 0.91567 0.11786  0.616   
